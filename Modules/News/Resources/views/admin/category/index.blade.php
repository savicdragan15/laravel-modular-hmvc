                              ...
                              <tbody>
                                  <tr>
                                      ...
                                      <td class="text-center">
                                        <a href="{{ route('admin.newscategory.reorder') }}" target="_blank" class="btn m-badge--brand m-badge m-badge--wide">Reorder</a>
                                      </td>
                                      <td class="text-center">
                                        {!! $category->active ? '<span id="active-'.$category->id.'" data-value="0" data-url="'.route('admin.newscategory.active', ['id' => $category->id]).'" class="m-badge active-inactive  m-badge--success m-badge--wide">Active</span>' : '<span id="active-'.$category->id.'" data-value="1" data-url="'.route('admin.newscategory.active', ['id' => $category->id]).'" class="m-badge active-inactive  m-badge--danger m-badge--wide">Inactive</span>' !!}
                                      </td>
                                      <td class="text-center">
                                        <a href="{{ route('admin.newscategory.edit', ['id' => $category->id]) }}" target="_blank" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit details">
                              ...
                              <tbody>
                                @foreach($category->subcategories as $subcategory)
                                  <tr class="btn-secondary">
                                    ...
                                    <td class="text-left">
                                      <a href="{{ route('admin.newscategory.reorder') }}?parent_id={{ $category->id }}" target="_blank" class="btn m-badge--brand m-badge m-badge--wide">Reorder</a>
                                    </td>
                                    <td class="text-left">
                                      {!! $subcategory->active ? '<span id="active-'.$subcategory->id.'" data-value="0" data-url="'.route('admin.newscategory.active', ['id' => $subcategory->id]).'" class="m-badge active-inactive  m-badge--success m-badge--wide">Active</span>' : '<span id="active-'.$subcategory->id.'" data-value="1" data-url="'.route('admin.newscategory.active', ['id' => $subcategory->id]).'" class="m-badge active-inactive  m-badge--danger m-badge--wide">Inactive</span>' !!}
                                    </td>
                                    <td class="text-center">
                                      <a href="{{ route('admin.newscategory.edit', ['id' => $subcategory->id]) }}" target="_blank" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit details">
                                        <i class="la la-edit"></i>
                                      </a>
                                      <a href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Delete">
                                        <i class="la la-trash"></i>
                                  ...
                                  <tr class="btn-light">
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.newscategory.reorder') }}?subparent_id={{ $subcategory->id }}" target="_blank" class="btn m-badge--brand m-badge m-badge--wide">Reorder</a>
                                    </td>
                                    <td class="text-center">
                                      {!! $subsubcategory->active ? '<span id="active-'.$subsubcategory->id.'" data-value="0" data-url="'.route('admin.newscategory.active', ['id' => $subsubcategory->id]).'" class="m-badge active-inactive  m-badge--success m-badge--wide">Active</span>' : '<span id="active-'.$subsubcategory->id.'" data-value="1" data-url="'.route('admin.newscategory.active', ['id' => $subsubcategory->id]).'" class="m-badge active-inactive  m-badge--danger m-badge--wide">Inactive</span>' !!}
                                    </td>
                                    <td class="text-center">
                                      <a href="{{ route('admin.newscategory.edit', ['id' => $subsubcategory->id]) }}" target="_blank" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit details">
                                        <i class="la la-edit"></i>
                                      </a>
                                      <a href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Delete">
                                        <i class="la la-trash"></i>
