                          ...
                          @foreach($articles as $article)
                            <tr>
                              ...
                              <td class="text-center">
                                {!! $article->active ? '<span id="active-'.$article->id.'" data-value="0" data-url="'.route('admin.news.active', ['id' => $article->id]).'" class="m-badge active-inactive  m-badge--success m-badge--wide">Active</span>' : '<span id="active-'.$article->id.'" data-value="1" data-url="'.route('admin.news.active', ['id' => $article->id]).'" class="m-badge active-inactive  m-badge--danger m-badge--wide">Inactive</span>' !!}
                              </td>
                              <td>
