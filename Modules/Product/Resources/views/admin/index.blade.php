                        ...
                        <div class="table-responsive ">
                            ...
                            @foreach ($products as $key => $product)
                              <tr>
                                ...
                                <td class="text-center">
                                  {!! $product->active ? '<span id="active-'.$product->id.'" data-value="0" data-url="'.route('admin.product.active', ['id' => $product->id]).'" class="m-badge active-inactive  m-badge--success m-badge--wide">Active</span>' : '<span id="active-'.$product->id.'" data-value="1" data-url="'.route('admin.product.active', ['id' => $product->id]).'" class="m-badge active-inactive  m-badge--danger m-badge--wide">Inactive</span>' !!}
                                </td>
                                <td class="text-center">
