                        ...
                        <div class="table-responsive ">
                              ...
                              @foreach ($reviews as $review)
                                  <tr>
                                    ...
                                    <td class="text-center">
                                      {!! $review->active ? '<span id="active-'.$review->id.'" data-value="0" data-url="'.route('admin.productreview.active', ['id' => $review->id]).'" class="m-badge active-inactive  m-badge--success m-badge--wide">Active</span>' : '<span id="active-'.$review->id.'" data-value="1" data-url="'.route('admin.productreview.active', ['id' => $review->id]).'" class="m-badge active-inactive  m-badge--danger m-badge--wide">Inactive</span>' !!}
                                    </td>
                                    <td></td>
                                  </tr>
                              @endforeach
